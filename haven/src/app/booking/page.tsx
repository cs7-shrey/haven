...
const Booking = () => {
    ...
    return (
        <div className='relative h-screen flex flex-col z-10 bg-white/80'>
            ...
            <div className='flex z-30 justify-between max-w-full gap-4 mt-20 mx-8'>
                <div className='w-[50%] bg-white rounded-lg p-4 shadow-md'>
                    <div>
                ...
                <div className='w-[30%] bg-white rounded-lg shadow-md h-fit'>
            ...
            {booked && <div className='absolute inset-0 bg-secondary/80 z-50 flex justify-center items-center'>  
                <div className="flex flex-col items-center gap-2">
                    <div className="size-24">
                        <img src={'/assets/success.svg'} alt="success image" />
                    </div>
                    <div>
